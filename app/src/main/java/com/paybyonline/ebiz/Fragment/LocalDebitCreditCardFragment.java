 ...
 */
public class LocalDebitCreditCardFragment extends Fragment {
    ...
    public LocalDebitCreditCardFragment() {
    ...
    public void obtainUserPaymentType() {
        ...
        params.put("payMethod", "Debit Credit Card");
    ...
    public void handleObtainUserPaymentType(JSONObject response) throws JSONException {
        ...
        try {
            ...
            final LocalDCRecyclerViewAdapter adapter = new LocalDCRecyclerViewAdapter();
    ...
    public class LocalDCRecyclerViewAdapter extends RecyclerView.Adapter<LocalDebitCreditCardFragment.LocalDCRecyclerViewAdapter.NetBankingRecyclerViewHolder> {
        ...
        @Override
        public LocalDCRecyclerViewAdapter.NetBankingRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.generic_image_text_row, parent, false);
            return new LocalDCRecyclerViewAdapter.NetBankingRecyclerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(LocalDCRecyclerViewAdapter.NetBankingRecyclerViewHolder holder, int position) {
