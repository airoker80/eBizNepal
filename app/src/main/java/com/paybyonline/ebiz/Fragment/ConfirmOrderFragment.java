...
//        url = PayByOnlineConfig.SERVER_URL;
        ...
        if (null != bundleData) {
            ...
            confirmOrderBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    } else if (requestFrom.equals("Online Banking") && !bankName.equals("")) {

                        createUserPaymentServerOnlineBanking();

                    }
                    else if (requestFrom.equals("Debit Credit Card")){
                        createUserPaymentServerDebitCreditCard();
                    }
    ...
    public void createUserPaymentServerOnlineBanking() {
    ...
    public void createUserPaymentServerDebitCreditCard() {
        Intent intent = new Intent(getActivity(), PboWebViewActivity.class);
        bundleData.putString("userIp", userDeviceDetails.getLocalIpAddress());
        bundleData.putString("webViewPage", "Debit Credit Card");
        //bundleData.putString("pageTitle","NIBL Checkout");
...
//        RequestParams finalPayParams = new RequestParams();
        ...
        if (bundleData.getString("addDiscountWallet").equals(null)) {
            finalPayParams.put("addDiscountWallet", "0");
        } else {
...
//                });
        ...
        retrofitHelper.sendRequest(ApiIndex.GET_ON_REGISTER_USER_ENDPOINT, finalPayParams, null, null);
...
/*        PboServerRequestHandler handler = PboServerRequestHandler.getInstance(coordinatorLayout, getActivity());
        ...
        retrofitHelper.setOnResponseListener(new RetrofitHelper.OnRetrofitResponse() {
            ...
            @Override
            public void onRetrofitFailure(String errorMessage, int apiCode) {
                Log.d("Confirm Order", "error " + errorMessage);
            }
        });
...
//                });
        ...
        retrofitHelper.sendRequest(ApiIndex.GET_ON_VERIFY_INSTALLED_APP_ENDPOINT, finalPayParams, null, null);
    }
    ...
    public void handleconfirmSCTPayment(JSONObject response) throws JSONException {
        ...
        if (response.getString("msg").equals("Success")) {
            ...
            fragmentTransaction.replace(R.id.content_frame, fragment, Constants.DASHBOARD_MOBALET_FRAGMENT);
