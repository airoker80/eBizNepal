...
import com.paybyonline.ebiz.Adapter.ViewHolder.ChildRecycleViewDashboardHolder;
 ...
 */
public class ChildRecycleViewDashboardAdapter extends RecyclerView.Adapter<ChildRecycleViewDashboardHolder> {
    ...
    public ChildRecycleViewDashboardAdapter(Context context, List<ServiceType> serviceTypeList,
    ...
    @Override
    public ChildRecycleViewDashboardHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = inflater.inflate(childLayout, parent, false);
        return new ChildRecycleViewDashboardHolder(itemView);
    }

    @Override
    public void onBindViewHolder(ChildRecycleViewDashboardHolder holder, int position) {
     /*   if(serviceTypeList.get(position).getService_type_id().equals(servTypeId)){
        ...
        holder.bind(serviceTypeList.get(position),rechargeFormLayout,coordinatorLayout,serviceCatagoryId,servTypeId,parentPosition,serviceTypeList);
